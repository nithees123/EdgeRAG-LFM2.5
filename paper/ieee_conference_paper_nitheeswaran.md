...
**Nitheeswaran S**  
*Department of Computer Science and Engineering (Cyber Security), III Year*  
*Alpha College of Engineering*  
`s.nithees4621@gmail.com`  
...
### ROC and Precision-Recall Analytics
EdgeRAG achieves an **ROC Area Under Curve (AUC) of 0.965** and an **Average Precision (AP) of 0.978**, demonstrating superior classification threshold resilience compared to cloud baselines.

```
TABLE II: CONFUSION MATRIX BREAKDOWN (250 SAMPLES / 2,479 DOCUMENTS)
================================================================================================================
Matrix Cell Category              Count / Total    Percentage (%)    Model Evaluation Behavior
================================================================================================================
True Positive (TP)               182 / 200        91.0%             Correctly retrieved & cited factual answer
False Negative (FN)              18 / 200         9.0%              Missed document chunk during top-k retrieval
False Positive (FP)              3 / 50          6.0%              Low hallucination risk on unanswerable query
True Negative (TN)               47 / 50          94.0%             Correct out-of-domain (OOD) negative refusal
================================================================================================================
```
